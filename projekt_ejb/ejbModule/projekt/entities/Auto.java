...
@NamedQuery(name="Auto.findAll", query="SELECT i FROM Auto i")
...
//	@Temporal(TemporalType.DATE)
	...
	public String getDataOstatniegoPrzegladu() {
		return this.dataOstatniegoPrzegladu;
	}

	public void setDataOstatniegoPrzegladu(String dataOstatniegoPrzegladu) {
